...
![](/images/posts/Introduction-of-event-extraction/1.png)  
...
![Baseline CNN model for ED, where Baghdad is the current trigger candidate in a context window of 2 × 4 + 1 words](/images/posts/Introduction-of-event-extraction/2.png)   
...
![ED with Sentence Embedding](/images/posts/Introduction-of-event-extraction/3.png)  
...
![ED with Character-level Embedding](/images/posts/Introduction-of-event-extraction/4.png)  
...
![CNN model for argument role prediction](/images/posts/Introduction-of-event-extraction/5.png)  
